...
_WORKOUT_RULES = (
    ...
    "- For alternatives separated by '/', keep the full exercise name and put useful instructions/progression notes in notes.\n"
    "- For timed work like '20-60 seconds', put the time range in notes and leave target_reps null.\n"
