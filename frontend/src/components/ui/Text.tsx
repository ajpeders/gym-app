...
const variants: Record<Variant, string> = {
  title: 'text-[33px] leading-10 font-black text-iron-50',
  heading: 'text-xl leading-6 font-black text-iron-50',
  ...
  eyebrow: 'text-xs leading-4 font-black uppercase text-brand',
