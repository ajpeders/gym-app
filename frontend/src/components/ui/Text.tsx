...
const variants: Record<Variant, string> = {
  title: 'text-[32px] leading-[38px] font-black tracking-[-0.45px] text-iron-50',
  heading: 'text-xl leading-7 font-extrabold tracking-normal text-iron-50',
  ...
  eyebrow: 'text-[11px] leading-4 font-black uppercase tracking-[2.1px] text-brand',
